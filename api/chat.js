export default async function handler(req, res) {
  // --- 1. TAMBAHKAN CORS HEADERS DI SINI ---
  res.setHeader('Access-Control-Allow-Origin', '*'); // Mengizinkan request dari domain apa saja (termasuk Acode)
  res.setHeader('Access-Control-Allow-Methods', 'POST, OPTIONS');
  res.setHeader('Access-Control-Allow-Headers', 'Content-Type');

  // Tangani Preflight Request dari browser (Wajib untuk CORS)
  ...
  // ... (Sisa kodemu yang berisi amogenzKnowledge dan logic fetch ke Gemini biarkan sama persis seperti sebelumnya) ...
